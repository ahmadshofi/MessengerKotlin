...
import com.ahmad.messengerkotlin.message.LatesMessagesActivity
...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 0 && resultCode == Activity.RESULT_OK && data != null){
            Log.d("RegisterAcitivity","Photo was selected")
...
//            select_photo_button_register.setBackgroundDrawable(bitmapDrawable)
    ...
    private fun performRegister() {
        ...
        if (email.isEmpty() || password.isEmpty()){
            Toast.makeText(this,"Please Enter text email/pw",Toast.LENGTH_SHORT).show()
            return
        }
